...
export default function CategorySection() {
  ...
  function CardCategories(filtername) {
    return (
  ...
  return (
    <>
      ...
      {CardCategories(filtercoop)}
      {CardCategories(filteronline)}
      <Footer />
    </>
  );
}
export function CategorySectionAccion() {
  const [game, setGame] = useState([]);
